 ...
 * Displays all notifications for the doctor with filtering and quick actions
 */
const DoctorNotifications = () => {
  ...
  const handleNotificationClick = (notification) => {
    ...
    } else if (notification.type.includes('feedback')) {
      ...
      <div className="space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-neutral-600 mt-1">Stay updated with appointments and patient requests</p>
          </div>
